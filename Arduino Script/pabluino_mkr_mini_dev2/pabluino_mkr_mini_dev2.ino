...
// Communication with IPs (Processing, python) 
...
//      }
    ...
    if ( (size = Udp.parsePacket()) > 0)
    {
      ...
      // Debug print OSC contents
      osccount++;
      Serial.print(ip);
      Serial.print(" ");
      Serial.print(osccount);
      Serial.print(" ");
      ...
      if (!bundleIN.hasError())
      {
        ...
        Serial.print("bundleIN error:");
        OSCErrorCode err = bundleIN.getError(); 
        Serial.println(err);
...
//        Serial.println(msg);
//        char a = msg.getType(0);
//        Serial.println(a);
        }

      //TODO Check else error content
...
void checkType(OSCMessage &msg){
    Serial.println(msg.isInt(0));
    Serial.println(msg.isFloat(0));
    Serial.println(msg.isBlob(0));
    Serial.println(msg.isChar(0));
    Serial.println(msg.isString(0));
    Serial.println(msg.isDouble(0));
}
